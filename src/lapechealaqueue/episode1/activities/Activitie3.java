...
public class Activitie3 extends Activity {
	...
	ImageView exit, home, oui, non, rep_1, rep_2, rep_3, valider, repeat, vrai,
			incomplet, faux,rep_c1,rep_c2,rep_c3,fille_non,fille_oui,main_fille,fille_fictif,ogre_exit;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activitie3);
		act = this;
		...
		rep_1.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				rep_2.setBackgroundResource(R.drawable.choix2_act3);
				rep_3.setBackgroundResource(R.drawable.choix3_act3);
				_rep_2 = false;
				_rep_3 = false;
				...
				if (_rep_1 == false) {
					rep_1.setBackgroundResource(R.drawable.choix1_s_act3);
					_rep_1 = true;
				} else {
					rep_1.setBackgroundResource(R.drawable.choix1_act3);
					_rep_1 = false;
				}
			}
		});
		...
		rep_2.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				if (_rep_2 == false) {
					rep_2.setBackgroundResource(R.drawable.choix2_s_act3);
					_rep_2 = true;
				} else {
					rep_2.setBackgroundResource(R.drawable.choix2_act3);
					_rep_2 = false;
		...
		rep_3.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				if (_rep_3 == false) {
					rep_3.setBackgroundResource(R.drawable.choix3_s_act3);
					_rep_3 = true;
				} else {
					rep_3.setBackgroundResource(R.drawable.choix3_act3);
					_rep_3 = false;
		...
		valider.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				if ((_rep_1 == false) && (_rep_2 == false) && (_rep_3 == false)) {
				...
				else if ((_rep_1 == true) && (_rep_2 == true)
						&& (_rep_3 == true)) {
					_rep_1 = false;
					_rep_2 = false;
					_rep_3 = false;
					...
					rep_2.setBackgroundResource(R.drawable.choix2_act3);
					rep_3.setBackgroundResource(R.drawable.choix3_act3);
					mpFaux = MediaPlayer.create(Activitie3.this, R.raw.faux);
				...
				} else if (_rep_1 == true && _rep_3 == false && _rep_2 == false) {

					mpVrai = MediaPlayer.create(Activitie3.this, R.raw.vrai);
					mediaVrais();
					...
					rep_1.setBackgroundResource(R.drawable.choix1_v_act3);
					...
					if(_rep_2 == true){
						rep_2.setBackgroundResource(R.drawable.choix2_f_act3);	
						
					}
					
					if(_rep_3 == true){
						rep_3.setBackgroundResource(R.drawable.choix3_f_act3);	
	...
	public void testEpisode() {
		...
		for (int i = 0; i < packs.size(); i++) {
			...
			if (packageName.equals("com.sanabilmed.logrejoueur.episode2")) {
				testEpisode = true;
